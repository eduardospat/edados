...
typedef struct _grafo {
    ...
    int numLocais;
    bool orientado;
    Caminho caminho[MAX_ARESTAS];
    int consultaArestasIndex;
    int origemConsultaArestas;
} Grafo;
...
bool g_proxima_aresta(Grafo* self, char** origem, char** destino, double* distancia);
